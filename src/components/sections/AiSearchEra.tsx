    ...
    <section className="py-24 sm:py-32">
      <Container>
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <Reveal>
            <div className="card flex h-full flex-col gap-5 rounded-3xl p-8">
          ...
          <Reveal delay={0.1}>
            <div className="card relative flex h-full flex-col gap-5 overflow-hidden rounded-3xl p-8">
              <div className="animate-drift-slow pointer-events-none absolute -right-16 -top-16 size-56 rounded-full bg-gradient-to-br from-primary/20 to-gold/10 blur-2xl" />
              <span className="inline-flex w-fit items-center gap-2 rounded-full bg-primary-soft px-3 py-1 text-xs font-medium text-primary-dark">
                <Sparkles className="size-3.5" /> 지금의 AI 검색
              </span>
              <p className="text-lg font-medium leading-snug text-ink">
                "민감성 피부 진정 성분 추천해줘" → AI의 답변 한 줄 → 그 안에 언급된 브랜드만 고려군에 진입
              </p>
              <div className="mt-2 rounded-2xl border border-primary/20 bg-white/70 p-5 text-sm leading-relaxed text-ink">
                <span className="text-muted">"민감성 피부에는 병풀 추출물과 판테놀 성분이 도움이 됩니다.
                이 성분을 담은 제품으로는 </span>
                <span className="font-semibold text-primary">브랜드가 여기에 들어갑니다</span>
