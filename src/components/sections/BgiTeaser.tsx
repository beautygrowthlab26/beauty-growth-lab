...
export function BgiTeaser() {
  return (
    <section className="py-24 sm:py-32">
      <Container>
        <div className="card relative overflow-hidden rounded-[2.5rem] px-8 py-14 sm:px-16 sm:py-20">
          <div className="animate-drift pointer-events-none absolute -left-24 -top-24 size-72 rounded-full bg-gradient-to-br from-primary/20 to-gold/10 blur-3xl" />

          <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.2fr_1fr]">
            <Reveal>
              <div className="flex flex-col gap-6">
                <Badge tone="gold">무료 진단</Badge>
            ...
            <Reveal delay={0.1}>
              <div className="card mx-auto flex w-full max-w-xs flex-col items-center gap-4 rounded-3xl p-8">
                ...
                <div className="relative flex size-40 items-center justify-center">
                  ...
                  <div className="absolute flex flex-col items-center">
                    <Gauge className="mb-1 size-5 text-primary" />
